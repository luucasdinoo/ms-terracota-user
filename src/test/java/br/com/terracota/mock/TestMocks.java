...
public final class TestMocks {
    ...
    public static final User USER_TEST = User.create(
            "johndoe",
            "12345678",
            "John Doe",
    ...
    public static final User USER_CUSTOMER_TEST = User.create(
            "johndoe",
            "12345678",
            "John Doe",
            "johndoe123@gmail.com",
    ...
    public static final Document DOCUMENT_TEST = Document.create(
            "12345678900",
            DocumentType.CPF
    );

    public static final User USER_CRAFTSMAN_TEST = User.create(
            "johndoe",
            "12345678",
            "John Doe",
            "johndoe123@gmail.com",
    ...
    public static final Customer CUSTOMER_TEST = Customer.create(
            USER_CUSTOMER_TEST,
